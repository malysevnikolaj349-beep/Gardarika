...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Optimization: Run blocking DB operation in a separate thread.
...
async def choose_faction(
    ...
    try:
        ...
        await asyncio.to_thread(
            create_character, user_id, player.name,
            player.character_class.name, player.faction['name'], stats_for_db
        )
